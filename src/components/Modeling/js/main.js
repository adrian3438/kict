...
import { commonSetting, setGui, setHelper } from './_utils';
import { settings, actionValue, currentData, world  } from './_common';
import { createBubble, changeBubble } from './_bubble';
...
const App = function (datas) {
  if (typeof window !== "undefined" && typeof document !== "undefined") {
    ...
    // 
    // changeCurrentData(datas.List[2]);
